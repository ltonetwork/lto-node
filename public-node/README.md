...
View your anchor transactions in our explorer:
 - MAINNET: [explorer.lto.network](https://explorer.lto.network)
 - TESTNET: [testnet-explorer.lto.network](https://testnet-explorer.lto.network) 